        ...
        <div className="dashboard-layout" style={{ background: 'var(--background)' }}>
            ...
            <aside className="sidebar" style={{ borderRight: '1px solid var(--border-color)', padding: '1.5rem 1rem', background: 'var(--background)' }}>
                ...
                <nav style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                    ...
                    <Link href="/dashboard/schedule" className={`sidebar-link ${pathname === '/dashboard/schedule' ? 'active' : ''}`} style={{ fontSize: '0.9rem', padding: '0.6rem 0.8rem' }}>
                    ...
                    <Link href="/dashboard/team" className={`sidebar-link ${pathname === '/dashboard/team' ? 'active' : ''}`} style={{ fontSize: '0.9rem', padding: '0.6rem 0.8rem' }}>
                    ...
                    <p style={{ fontSize: '0.75rem', fontWeight: 600, color: 'var(--text-muted)', textTransform: 'uppercase', padding: '0.5rem', marginTop: '1.5rem' }}>Sistema</p>
                    <Link href="/dashboard/settings" className={`sidebar-link ${pathname === '/dashboard/settings' ? 'active' : ''}`} style={{ fontSize: '0.9rem', padding: '0.6rem 0.8rem' }}>
